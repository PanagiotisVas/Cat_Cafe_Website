...
## Key Features
* **📱 Fully Responsive:** Built with a "Mobile-First" approach using CSS Flexbox and Grid. Adapts to any screen size.
...
├── Video/        # Video about cats (For Home Page)     
├── CSS/
│   ├── global.css     # Global Style Settings
│   ├── home.css       # Home Page
│   └── ...            # Styling for all the pages (+ Header & Footer)
│   
├── HTML
...
### Home Page
![Home Page](Website%20Pictures/HomePage1.png)
![Home Page](Website%20Pictures/HomePage2.png)

### About Us Page
![About Us Page](Website%20Pictures/AboutUs.png)

### Contact Us Page
![Contact Us Page](Website%20Pictures/ContactUs.png)
